// assignment-12.surge.sh
// String
// str="I am Shoaib. I am studying at University of Agriculture Faisalabad.";
...
// let guess="Shoaib"//console.log(Math.random()*100);
// while(input!==guess){
...
//     break;}
// }
//Reverseing a Number from user input
...
// let series=45//prompt("Enter a Number");
// let tostr=console.log(series.toString());
// console.log(tostr);
// let split=tostr.split('');
// console.log(split);
// let splitd=console.log(split);
// for(index in splitd){
//     console.log(index,splitd[index]);
// }
...
// function table(){
// let tablefor= +prompt("ENter a number to get its table:");
// let start= +prompt("Enter number to start table from:");
// let end= +prompt("Enter number to end table to:");
//     for(let i=start;i<=end;i++){
//     console.log(tablefor,'*',i,'=',tablefor*i);
// }   console.log(tablefor,'*',i,'=',tablefor*i);
// }
// console.log(table());
